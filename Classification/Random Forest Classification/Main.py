...
dataset = pd.read_csv(r'D:\Learning\Udemy ML\MLPracticeProjects\Classification\Random Forest Classification\Social_Network_Ads.csv')
...
classifier = RandomForestClassifier(n_estimators = 100, criterion = 'entropy', random_state = 0) # by default 'gini' for criterion
    # and 100 for n_estimators
    # making n_estimators doesn't really help right as the accuracy is same and increasing it further might lead to overfitting
