...
dataset = pd.read_csv(r'D:\Learning\Udemy ML\MLPracticeProjects\Classification\Decision Tree Classification\Social_Network_Ads.csv')
...
classifier = DecisionTreeClassifier(criterion = 'entropy', random_state = 0) # by default 'gini'
